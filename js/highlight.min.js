...
begin:/[-+*/=%^~]|&&?|\|\|?|!=?|<(?:=>?|<|>)?|>[>=]?/,relevance:0}]}}})()
;hljs.registerLanguage("sql",e)})();/*! `php` grammar compiled for Highlight.js 11.3.1 */
...
})();hljs.registerLanguage("xml",e)})();/*! `php-template` grammar compiled for Highlight.js 11.3.1 */
